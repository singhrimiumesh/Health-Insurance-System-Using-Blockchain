...
const Healthcare = ({ goBack }) => {
    ...
    const contractAddress = "0x670881891404fec37c6b6b5a5e21859eb9367451";
    ...
    const addRecord = async () => {
        try {
            const tx = await contract.addRecord(patientID, "Alice", diagnosis, treatment, treatmentCost);
            await tx.wait();
            fetchPatientRecords();
            await tx.wait();
    ...
    return(
        <div className='container'>
            ...
            <h1 className = "title">HealthCare Provider</h1>
